...
namespace _6968617465796f750d0a.Services.Win32
{
    internal class Funnys
    {

        private int MonitorX = Convert.ToInt32(SystemParameters.PrimaryScreenWidth);
        private int MonitorY = Convert.ToInt32(SystemParameters.PrimaryScreenHeight);
        ...
        public async void BlurEffect()
        {
            ...
            while (true)
            {
                ...
                AlphaBlend(hdc, rnd.Next(-4, 4), rnd.Next(-4, 4), x, y, mhdc, 0, 0, x, y, new BLENDFUNCTION(0,0,70,0));
        ...
        public async void InvertColors()
        {
            ...
            uint[] colors = { 0xFF0000, 0xFFFFFF, 0x00FF80, 0x000000, 0x6A82FA, 0x002BFF, 0x9100FF, 0xAE52F5, 0xE4AF04, 0x777670, 0xFF9100, 0xFF00EF, 0x00EFFF };
